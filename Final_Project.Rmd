...
Highly skewed data after 2015. Limited insights into the trend across the whole timeline
Unexplored factors that might be more predictive of the user ratings, such as sales data and user anticipation. 
Due to the limitation of available data, we are NOT able to confirm the submission time of the ratings. We based the analysis on the release date of the movies. 
