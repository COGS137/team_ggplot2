...
2. Which movie genre receive the highest and lowest rating after 2010?
3. Does a movie released during a holiday season tend to receive a lower rating?
...
Adding year and genre to predict rating:
```{r}
linear_reg() |>
  set_engine("lm") |>
