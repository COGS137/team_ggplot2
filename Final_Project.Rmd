...
Alternatively, are the reviews available on IMDb reliable in correctly reflecting the quality of the movie or are they influenced by external factors that are less relevant to movies?
=======
Moviegoers who are interested in the evaluation of movies before consumption has limited knowledge about how online user reviews work and their subjectivity to misinformation. By looking at the trend of recent year’s reviews, we hope to achieve a more guided overview of online viewer ratings to provide a better decision-making process for viewers.
...
>>>>>>> a7a5ef0a89481305af100d319c6820c9ca6998fe
...
The model shows that, after 2010, when action movies received an average rating of 5.42, people give lower ratings across the years. People tend to give a rating of around 6.35 in 2011 and 6.36 in 2012, but only tend to give a rating of 5.79 in 2020 and 5.65 in 2021. Moreover, dramas receive a rating of 5.77 on average, comedies receive a rating of 5.61, and documentaries receive a rating of 6.49. It is worth noticing that musicals receive an average rating of 7.21, which makes it the highest-rated genre, while thrillers only receive an average rating of 4.98, which makes it the lowest-rated genre.
...
Since the p-value of 0.78 is larger than the typical alpha threshold of 0.05, we fail to reject the null hypothesis. Consequently, there is not a difference between the ratings for movies released during holiday season and other months.

### Results
* Q1

We found that people give slightly lower movies ratings over the years since 2010.
